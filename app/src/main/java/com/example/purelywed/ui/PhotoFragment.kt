...
import com.example.purelywed.databinding.FragmentPhotoBinding
...
class PhotoFragment : Fragment() {
    ...
    private val sampleData = listOf(
        CardItem("Drone Photography", R.drawable.dron),
        CardItem("Traditional Photography", R.drawable.tradatitional),
        CardItem("Cinematic Videography", R.drawable.video),
        CardItem("Candid Photography", R.drawable.candid)
    )
